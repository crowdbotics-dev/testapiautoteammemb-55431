...
## Project Structure
    ...
    ├── testapiautoteammemb_55431  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55431`
...
2. Clone this repo and `cd testapiautoteammemb_55431`
